...
Revision ID: 4ad0814e90fd
Revises: 
Create Date: 2025-07-26 14:18:31.717944
...
def upgrade() -> None:
    ...
    sa.Column('document_file_url', sa.String(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('email'),
    ...
    op.create_table('edudiagno_tests',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('title', sa.String(), nullable=True),
    sa.Column('description', sa.String(), nullable=True),
    sa.Column('tech_field', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    op.create_index(op.f('ix_edudiagno_tests_id'), 'edudiagno_tests', ['id'], unique=False)
    ...
    sa.Column('edudiagno_test_id', sa.Integer(), nullable=True),
    sa.Column('is_approved', sa.Boolean(), nullable=True),
    sa.Column('is_deleted', sa.Boolean(), nullable=True),
    sa.Column('admin_notes', sa.String(), nullable=True),
    ...
    sa.Column('edudiagno_test_response_id', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['edudiagno_test_response_id'], ['edudiagno_test_responses.id'], ondelete='CASCADE'),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('interview_question_id', 'interview_id', 'edudiagno_test_response_id', name='uq_interview_question_response')
    )
    ...
    sa.ForeignKeyConstraint(['quiz_question_id'], ['quiz_questions.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('quiz_question_id', 'interview_id', 'edudiagno_test_response_id', name='uq_quiz_response')
    )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_edudiagno_tests_id'), table_name='edudiagno_tests')
    op.drop_table('edudiagno_tests')
